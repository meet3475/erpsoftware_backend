...
const AllCompanyApis = {
    ...
    createcompany: (req,res,next) => {
        ...
        const company_phone = body?.company_phone ? body?.company_phone.trim() : '';
        const company_mobile = body?.company_mobile ? body?.company_mobile.trim() : '';
        ...
        const company_pan_no = body?.company_pan_no ? body?.company_pan_no.trim() : '';
        const company_tan_no = body?.company_tan_no ? body?.company_tan_no.trim() : '';
        const company_cin_no = body?.company_cin_no ? body?.company_cin_no.trim() : '';
        const company_fssai_no = body?.company_fssai_no ? body?.company_fssai_no.trim() : '';
